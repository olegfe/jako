...
urlpatterns = [
    ...
    url(r'^sale$', app.views.sale, name='sale'),
    url(r'^blog$', app.views.blog, name='blog'),
    url(r'^blogpost$', app.views.blogpost, name='blogpost'),
    url(r'^videopost$', app.views.videopost, name='videopost'),
    url(r'^anketa$', app.views.anketa, name='anketa'),
    url(r'^brend$', app.views.brend, name='brend'),
    url(r'^(?P<parametr>\d+)/$', app.views.blogpost, name='blogpost'),
    url(r'^registration$', app.views.registration, name='registration'),    # для регистраци
    url(r'^blog$', app.views.blog, name='blog'),
    url(r'^login/$',
